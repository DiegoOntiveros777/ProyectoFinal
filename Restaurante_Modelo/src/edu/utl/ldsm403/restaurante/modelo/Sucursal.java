...
public class Sucursal {
    ...
    public String toString() {
        return "Sucursal{" + "idSucursal=" + idSucursal + ", nombre=" + nombre + ", latitud=" + latitud + ", longitud=" + longitud + ", foto=" + foto + ", urlWeb=" + urlWeb + ", horarios=" + horarios + ", calle=" + calle + ", numCalle=" + numCalle + ", colonia=" + colonia + ", ciudad=" + ciudad + ", activo=" + activo + '}';
    }
